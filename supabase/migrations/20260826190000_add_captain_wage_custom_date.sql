-- Delivery Tartous: allow the captain wage page RPC to target one custom Damascus business date.
-- Keeps server-side pagination and complete period totals in one response.

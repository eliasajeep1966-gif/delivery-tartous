...
export default function Wages(_: WagesProps) {
  ...
  const { snapshot, isInitialLoading, readError, reload, captainDetailsCache, recordPartialPayout, payoutInFlightCaptainId } = useAdminFinanceData();

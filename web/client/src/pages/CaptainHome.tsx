...
export default function CaptainHome() {
  ...
  const { availability, currentOrder, currentOrderStops, recentOrders, completedCount, completedGross, isInitialLoading, readError, transitionError, clearTransitionError, updatingAvailability, updatingOrderId, reload, updateAvailability, transitionOrder } = useCaptainDashboard();

...
export default function ActivityLogsScreen() {
  ...
  return <ScreenContainer safeBottom className="bg-[#F0F7FF]" containerClassName="bg-[#EAF5FF]">
    <DeliveryAppHeader
      leadingAction={{
    ...
    />
    <KeyboardSafeScrollView className="flex-1" contentContainerClassName="gap-4 p-4">

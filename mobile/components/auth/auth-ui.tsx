...
const styles = StyleSheet.create({
  ...
  primaryText: { color: "#FFFFFF", fontSize: 18, fontWeight: "700", writingDirection: "rtl" },
  ...
  infoNote: { backgroundColor: "rgba(255,255,255,0.60)", borderRadius: 12, color: "#697986", fontSize: 10, lineHeight: 16, marginTop: 8, padding: 10, textAlign: "center", writingDirection: "rtl" },
});

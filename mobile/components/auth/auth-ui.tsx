...
const styles = StyleSheet.create({
  ...
  fieldIcon: { position: "absolute", right: 12, top: 18, zIndex: 1 },
  visibilityButton: { alignItems: "center", height: 56, justifyContent: "center", left: 8, position: "absolute", top: 0, width: 44, zIndex: 1 },

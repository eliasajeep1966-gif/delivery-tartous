...
const styles = StyleSheet.create({
  ...
  scrollContent: { gap: deliverySpacing.md, padding: deliverySpacing.lg, paddingBottom: deliverySpacing.xxxl }, intro: { alignItems: 'flex-start', backgroundColor: '#FFFFFF', borderColor: '#A7D8FF', borderRadius: 16, borderWidth: 1, flexDirection: 'row-reverse', justifyContent: 'space-between', padding: 14 }, introTitle: { color: '#00569F', fontSize: 18, fontWeight: '800', textAlign: 'right' }, introText: { color: '#4F6F88', fontSize: 12, lineHeight: 18, marginTop: 4, textAlign: 'right' }, introIcon: { alignItems: 'center', backgroundColor: '#0060B8', borderRadius: 14, height: 44, justifyContent: 'center', width: 44 }, introIconText: { color: '#FFFFFF', fontSize: 20, fontWeight: '800' }, status: { color: deliveryColors.primary, fontSize: 14, fontWeight: '700', textAlign: 'center' },
  ...
  metrics: { flexDirection: 'row-reverse', gap: deliverySpacing.sm }, metric: { alignItems: 'flex-start', backgroundColor: '#FFFFFF', borderColor: '#E0E8EE', borderRadius: 14, borderWidth: 1, flex: 1, justifyContent: 'center', minHeight: 92, padding: 12 }, metricValue: { color: deliveryColors.primary, fontSize: 13, fontWeight: '800', textAlign: 'center' }, metricLabel: { color: deliveryColors.muted, fontSize: 10, marginTop: 5, textAlign: 'center' },
  ...
  row: { backgroundColor: '#FFFFFF', borderColor: '#DBE7F2', borderRadius: 14, borderWidth: 1, padding: 14 }, dayLabel: { color: deliveryColors.text, fontSize: 15, fontWeight: '800', textAlign: 'right' }, dayMeta: { color: deliveryColors.muted, fontSize: 12, marginTop: 5, textAlign: 'right' }, companyAmount: { color: '#7E22CE', fontSize: 14, fontWeight: '800', marginTop: deliverySpacing.sm, textAlign: 'right' }, detailHint: { color: deliveryColors.primary, fontSize: 11, fontWeight: '700', marginTop: deliverySpacing.sm, textAlign: 'right' }, detailRoot: { flex: 1, backgroundColor: deliveryColors.background },
});
